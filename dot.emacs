...
(custom-set-faces
 ...
 '(font-wikipedia-bold-face ((((class color) (background light)) (:inherit bold))))
 '(font-wikipedia-italic-face ((((class color) (background light)) (:inherit italic))))
 '(font-wikipedia-math-face ((((class color) (background light)) (:inherit font-lock-function-name-face))))
 '(font-wikipedia-sedate-face ((((class color) (background light)) (:inherit variable-pitch :foreground "SlateGray" :height 1.25))))
 '(font-wikipedia-string-face ((((class color) (background light)) (:inherit font-lock-string-face))))
 '(font-wikipedia-verbatim-face ((((class color) (background light)) (:inherit font-lock-constant-face))))
